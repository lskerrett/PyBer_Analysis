...
We were asked by the CEO to create a summary DataFrame of the key metrics for the ride-sharing data by city type. We received data from the company and use Panda, Numpy and Matplolib 
